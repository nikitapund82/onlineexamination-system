...
<a href="#" class="pull-right btn sub1" data-toggle="modal" data-target="#login"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Admin</b></span></a>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" value="Register Now" class="btn btn-primary"/>
  </div>
</div>
